...
#build rmvb library
ifneq ($(strip BUILD_WITH_RMVB),)
BUILD_WITH_RMVB := true
endif
## precise GC ##
...
MAKEFILE_PATH_CACHE=build/makefile-path.cache

ifneq ($(MAKEFILE_PATH_CACHE),$(wildcard $(MAKEFILE_PATH_CACHE)))
$(info generate makefile path cache: $(MAKEFILE_PATH_CACHE))
$(shell build/tools/findleaves.py --prune=out --prune=.repo --prune=.git $(subdirs) Android.mk > $(MAKEFILE_PATH_CACHE))
endif
$(info use makefile path cache: $(MAKEFILE_PATH_CACHE))
subdir_makefiles := $(shell cat $(MAKEFILE_PATH_CACHE))
