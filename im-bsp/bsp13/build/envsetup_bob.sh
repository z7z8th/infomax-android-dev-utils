...
function fix_blcr(){
    ...
    local blcr_run_opt=
    croot
    cd external/blcr-$BLCR_VERSION
    [ "$1" == "-c" ] && { rm .gitignore; git clean -df; git checkout .gitignore; rm -rf build/; }
    ./run.sh
    croot
}
...
## INFOMAX START for BLCR
## specifi BLCR version to build
BLCR_VERSION="0.8.5_b4"
## INFOMAX END for BLCR
...
function infomax_brunch()
{
	...
	ANDROID_BOARD_LIST=( device/infomax/iM9816 \
			device/infomax/iM98xx_evb_v1 \
			device/infomax/iM98xx_evb_v2 \
			device/infomax/iM98xx_evb_v3 \
			device/infomax/iM98xx_evb_v3_wvga \
			device/infomax/iM98xx_evb_v4 \
			device/infomax/iM98xx_evb_v4_wvga )

	ANDROID_SYSTEM_LIST=( generic_iM9816-eng \
			generic_iM98xx_evb_v1-eng \
			generic_iM98xx_evb_v2-eng \
			full_iM98xx_evb_v3-eng \
			full_iM98xx_evb_v3_wvga-eng \
			full_iM98xx_evb_v4-eng \
			full_iM98xx_evb_v4_wvga-eng )
    ...
    export DEVICE_NAME_TYPE=${DEVICE_NAME_LIST[$BOARD_NUMBER]}
